...
`), font: Wt, pos: S(e, -e), anchor: "botleft", size: 16, width: be() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: J(127, 127, 127) }, info: { color: J(255, 255, 255) }, error: { color: J(255, 0, 127) } } });
  ...
  loadSprite("r\xF6hre", "sprites/pipe.png");
  loadSprite("r\xF6hreUnten", "sprites/pipeBottom.png");
  ...
  scene("game", () => {
    const level = addLevel(level1, {
      ...
      tiles: {
        ...
        "&": () => [
          sprite("r\xF6hreUnten", { flipY: true }),
          area(),
          body({ isStatic: true }),
          anchor("bot")
        ],
